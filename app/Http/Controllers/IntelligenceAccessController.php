  ...
  public function store(Request $request)
    {
        ...
        /* ==========================================
           UPSERT LEAD — update if exists, create if new
        ========================================== */
        $lead = IntelligenceLead::updateOrCreate(
            [
        ...
        if ($request->plan === 'card') {
            ...
            /* ==========================================
               UPSERT TRANSACTION — update if exists, create if new
            ========================================== */
            Transaction::updateOrCreate(
                [
                    'intelligence_lead_id' => $lead->id  // ✅ Match by lead
                ],
                [
