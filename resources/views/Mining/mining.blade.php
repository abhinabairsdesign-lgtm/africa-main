                        ...
                        <div class="d-flex flex-wrap gap-5 mt-5 pt-3 border-top border-white border-opacity-10">
                            <div>
                                ...
                                <small class="text-uppercase text-white-50 tracking-widest"
                                    style="font-size: 9px;">Geological Confidence</small>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <small class="text-uppercase text-white-50 tracking-widest"
                                    style="font-size: 9px;">Resource Mapping</small>
                            </div>
                        </div>
                ...
                <div class="row mb-5">
                    <div class="col-lg-8">
                        <h6 class="text-uppercase tracking-widest fw-bold mb-3"
                            style="color: #8892b0; letter-spacing: 5px;">Natural Asset Portfolio</h6>
                        <h2 class="display-5 fw-bold" style="color: #0a192f;">Critical & <span
                                style="color: #d4af37;">Precious Minerals</span></h2>
                    </div>
                </div>
        ...
        <section class="mining-risk-map text-white">
            <div class="container">
                <div class="row mb-5">
                    <div class="col-lg-6">
                        <h6 class="text-uppercase tracking-widest fw-bold mb-3"
                            style="color: #d4af37; letter-spacing: 5px;">Strategic Advisory</h6>
            ...
            <div class="container">
                <div class="row mb-5 text-center">
                    <div class="col-lg-8 mx-auto">
                        <h6 class="text-uppercase tracking-widest fw-bold mb-3"
                            style="color: #d4af37; letter-spacing: 5px;">Operational Strategy</h6>
            ...
            <div class="container py-5">
                ...
                <div class="row mb-5 align-items-end">
                    <div class="col-lg-8 border-start border-4 border-success ps-4">
                        <h6 class="text-uppercase tracking-widest fw-bold text-success mb-2"
                            style="letter-spacing: 3px;">ESG Commitment</h6>
